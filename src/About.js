...
class About extends Component {
    ...
    render() { 
        ...
        <body>
            ...
            <div className='name'>
                <h4>Triana</h4>
                <img src='../src/assets/beerIcon1.png' alt ='beer'/>
                <a href="http://www.linkedin.com/in/triana-cerda/">
                <img src="../src/assets/linkdinbtn.jpg" alt="Visit my LinkedIn Profile"/>
                </a>
            ...
            <div className='name'>
                <h4>Cristian</h4>
                    <img src='../src/assets/beerIcon2.png' alt ='beer'/>
            ...
            <div className='name'>
                <h4>Simon</h4>
                    <img src='../src/assets/beerIcon3.png' alt ='beer'/>
            ...
            <div className='name'>
                <h4>Aemilius</h4>\
                    <img src='../src/assets/beerIcon4.png' alt ='beer'/>
            ...
            <div className='name'>
                <h4>Alice</h4>
                    <img src='../src/assets/beerIcon5.png' alt ='beer'/>
